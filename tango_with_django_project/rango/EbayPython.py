...
def getCompletedItems(ebaySearch):
	selector = ["PictureURLSuperSize"]

	completedItemsSearchResult = findCompletedItems(keywords=ebaySearch, outputSelector=selector)
...
if  __name__ =='__main__':
	...
	getCompletedItems("Star rubies 1997")
